...
const StyledWrapper = styled.div`
  ...
  .wheel-ring1 {
    animation: spinning 0.5s linear infinite; /* faster spin */
  }
  ...
  .container-wheel1 {
    animation: bounce1 1.5s infinite; /* faster bounce */
  }

  .container-wheel2 {
    animation: bounce2 1.5s infinite; /* faster bounce */
  }

  @keyframes bounce1 {
    0%, 50% { transform: translateY(0px); }
    52% { transform: translateY(-20px); } /* stronger bounce */
    65% { transform: translateY(0px); }
  }

  @keyframes bounce2 {
    0%, 28% { transform: translateY(0px); }
    30% { transform: translateY(-10px); } /* stronger bounce */
    45% { transform: translateY(0px); }
  }

  /*car-body*/
  .car-container {
    animation: lift 1.5s infinite cubic-bezier(0.96, 0.5, 0.27, 0.55);
    transform-origin: center;
  }

  @keyframes lift {
    0%, 30% { transform: rotate(0deg) translateY(0px); }
    32% { transform: rotate(-3deg) translateY(-20px); } /* more lift */
    48%, 50% { transform: rotate(0deg) translateY(0px); }
    56.5% { transform: rotate(3deg) translateY(-10px); } /* more lift */
    68% { transform: rotate(0deg) translateY(0px); }
  }

  /*obstacle*/
  .obstacles {
    animation: displacement 1.5s linear infinite; /* faster movement */
  }
