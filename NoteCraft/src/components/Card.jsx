              ...
              <div className="relative z-10">
                ...
                <div className="prose prose-lg max-w-none">
                  <div
                    className={
                      Theme === "Light"
                        ? "text-gray-700 leading-relaxed text-lg md:text-xl"
                        : "text-gray-300 leading-relaxed text-lg md:text-xl"
                    }
                    style={{ color: Theme === 'Light' ? '#374151' : '#d1d5db' }} // <-- Add inline style as backup
